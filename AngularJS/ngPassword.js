var password = angular.module('myPassword', []);


    //HEADER
    password.controller("header",  ['$scope', function ($scope){
        //header da definire
    ...
    //BODY
    password.controller('password', ['$scope', '$http', '$window', '$interval', '$location', function ($scope, $http, $window, $interval, $location){
    ...
    //FOOTER
    password.controller('footer', ['$scope',  function ($scope){
